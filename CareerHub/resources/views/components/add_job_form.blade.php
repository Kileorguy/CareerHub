...
<button class="text-xl font-bold" onclick="document.querySelector('[data-unique-id=\'add-job-form\']').showModal()">+</button>

<dialog class="modal" data-unique-id="add-job-form">
    <div class="modal-box">
        <form method="dialog">
        ...
        <form class="flex flex-col justify-start items-start" action="/addCompanyJob" method="POST">
            @csrf
