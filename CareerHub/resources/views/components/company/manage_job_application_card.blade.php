<div class="flex gap-6 p-6 rounded-lg shadow-lg border bg-white">
  ...
  <div class="w-full">
    <a href="{{route('employeeDetail', $jobApplication->user)}}" class="text-lg font-bold text-primary hover:underline">
  ...
  <div class="flex items-end gap-4 justify-end">
    <form method="POST" action="{{ route('updateJobApplicationStatus', [
